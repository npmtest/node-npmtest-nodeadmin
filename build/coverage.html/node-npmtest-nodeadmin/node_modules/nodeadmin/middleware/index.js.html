...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nodeadmin/node_modules/nodeadmin/middleware/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nodeadmin/node_modules/nodeadmin/middleware/index.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">97.3% <small>(36 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nodeadmin/node_modules/nodeadmin/middleware/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  fs.readFile('./secret.js', function(err, data) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (err.code === 'ENOENT') {
...
&nbsp;
  // ** Middleware
  return <span class="fstat-no" title="function not covered" >function nodeadmin(req,res,next) {</span>
